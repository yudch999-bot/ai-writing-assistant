...
import { BookOpen, Upload, FileText, Plus, Search, Link, Trash2, X, Eye, Copy, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="glass-card p-5">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 rounded-xl bg-[var(--color-surface-2)] border border-[var(--color-border)] border-dashed hover:border-[var(--color-primary)]/30 transition-all cursor-pointer text-center">
